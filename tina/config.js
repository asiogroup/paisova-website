      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            description: "1-2 sentence summary shown on blog cards and used as the SEO meta description.",
          ...
          },
          {
            ...
            name: "category",
            label: "Category",
            description: "Shown as the tag on the blog card.",
            options: [
              "Pre IPO",
              "Mutual Funds",
              "Stocks",
          ...
          },
          {
            ...
            name: "author",
            label: "Author",
            description: "Defaults to 'Paisova Team' if left blank.",
          },
          {
            type: "number",
            name: "readTime",
            label: "Read Time (minutes)",
            description: "Estimated reading time in minutes. Leave blank to auto-estimate from the body.",
          },
          {
            type: "image",
            name: "coverImage",
            label: "Cover Image",
            description: "Optional. Shown at the top of the post and on the blog card.",
          },
          {
            type: "rich-text",
            name: "body",

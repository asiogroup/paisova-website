                  ...
                  <div className="container">
                    ...
                    <div className="blog-grid">
                      {blogPreview.map((post, idx) => (
                        <Link key={idx} href="/blog" className="blog-card">
                          <div className="blog-card-image">
                            <div style={{ width: '100%', height: '100%', background: `linear-gradient(135deg, ${['#e8f0e8', '#f0e8d8', '#e0e8f0'][idx]} 0%, ${['#d8e8d0', '#f5e0c5', '#d5dce8'][idx]} 100%)`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2.5rem' }}>
                              {['📈', '🏦', '📊'][idx]}
                            </div>
                          </div>
